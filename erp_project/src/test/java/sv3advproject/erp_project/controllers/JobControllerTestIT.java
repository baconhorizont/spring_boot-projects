...
//        assertEquals("Z-form Szerszámgyártó Kft.", savedJob.getCustomer());
...
//        List<JobDto> result = client.get()
//                .uri(b->b.path("/api/jobs/allJobs").queryParam("customer","form").build())
//                .exchange()
//                .expectBodyList(JobDto.class)
//                .returnResult().getResponseBody();
//
...
//        List<JobDto> result = client.get()
//                .uri(b->b.path("/api/jobs/allJobs").queryParam("customer","form").queryParam("jobStatus","NEW").build())
//                .exchange()
//                .expectBodyList(JobDto.class)
//                .returnResult().getResponseBody();
//
...
//                .returnResult().getResponseBody();
//
//        assertEquals("Z-form Szerszámgyártó Kft.", result.getCustomer());
...
//                .returnResult().getResponseBody();
//
//        assertEquals(savedJob.getCustomer(),found.getCustomer());
